...
?>
            <form id="ticket-form">
                ...
                <div id="assunto">
                    ...
                    <?php } ?>
                    <input type="text" id="subject" name="title" <?php if ((!$edit || $validity != 3) && (!$edit || ($validity != 1 && $ticket->id != -1))) echo 'readonly'; ?> value="<?= $ticket->title ?>">
                </div>

                <div id="textArea">
                    <label for="fulltext">Mensagem:</label>
                    <textarea id="tickettext" name="fulltext" <?php if ((!$edit || $validity != 3) && (!$edit || ($validity != 1 && $ticket->id != -1))) echo 'readonly'; ?>><?= $ticket->text ?></textarea>
                </div>
